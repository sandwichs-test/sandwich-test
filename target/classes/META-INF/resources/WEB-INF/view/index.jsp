...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <div class="logo navbar-logo f-l mr-10 hidden-xs" style="width: 184px;text-align: left;" >功能菜单</div> <a class="logo navbar-logo-m f-l mr-10 visible-xs" ></a> 
...
<aside class="Hui-aside">
	...
	<dl id="menu-member">
			<dt><i class="Hui-iconfont">&#xe60d;</i> 测试案例管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
		...
		<dl id="menu-comments">
			<dt><i class="Hui-iconfont">&#xe622;</i> 组件管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的桌面" data-href="hello">我的桌面</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="hello"></iframe>
	</div>
</div>
</section>
